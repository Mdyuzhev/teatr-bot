...
3. `mcp__homelab__run_shell_command` — `tail -10 /home/YOUR_SSH_USER/teatr-bot/logs/bot.log 2>/dev/null || tail -10 /home/YOUR_SSH_USER/teatr-bot/logs/stdout.log 2>/dev/null`
